...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/home/pi/uav_data_collector/data_collector.log"),
...
def read_sensor_data():
    try:
        ...
        flame_detected = random.random() < 0.05  # 5% chance of flame detection
        battery_level = 85.0 + random.uniform(-10.0, 5.0)
...
def capture_and_detect():
    try:
        # In a real application, you would capture an image from the camera
        # For example, using PiCamera:
...
def collect_and_send_data():
    try:
        ...
        sensor_reading = {
            ...
            "flameDetected": sensor_data.get("flameDetected", False),
        ...
        status_doc = {
            ...
            "timestamp": timestamp,
            "batteryLevel": sensor_data.get("batteryLevel", 0),
            "batteryVoltage": 11.7,  # Placeholder, replace with actual reading
